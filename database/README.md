...
Полное описание структуры БД: Полное описание структуры БД: [Описание таблиц.md](Описание%20таблиц.md)
...
Загрузка структуры: Выполните скрипт [Общая схема.sql](Общая%20схема.sql)

Наполнение данными: Используйте скрипт [Тестирование.sql](Тестирование%20.sql) для тестовых данных

Проверка работы: Используйте демонстрационные запросы: -- Пример из [Демонстрация запросов.sql](Демонстрация%20запросов.sql)
-- Проверка процедур из [Просмотр процедур.sql](Просмотр%20процедур.sql)
```sql
...
[Общая схема.sql](Общая%20схема.sql) - Основная структура базы данных

[Описание таблиц.md](Описание%20таблиц.md) - Документация по таблицам и связям

🔍 Аналитические скрипты

[Демонстрация запросов.sql](Демонстрация%20запросов.sql) - Примеры рабочих запросов

[Запросы для анализа производительности.sql](Запросы%20для%20анализа%20производительности.sql) - Выявление аномалий в данных

⚙️ Обслуживание

[Обслуживание базы данных.sql](Обслуживание%20базы%20данных.sql) - Оптимизация и обслуживание

[Просмотр процедур.sql](Просмотр%20процедур.sql) - Управление хранимыми процедурами

[Скрипты резервного копирования.sql](Скрипты%20резервного%20копирования.sql) - Бэкапы и восстановление
